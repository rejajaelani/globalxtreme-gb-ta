              ...
              <div class="card">
                <div class="card-header bg-white">
                  <a href="tambah-data/" class="btn bg-custom-lgreen mt-2 mb-2" style="color: #FFFF !important;">
                    <i class="fas fa-plus"></i> Tambah Data Package
                  </a>
                  <h3 class="card-title text-center" style="width: 100%;">Data Packages</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                      // Query SQL untuk mengambil data packages
                      $sql = "SELECT packages.*, jenis.Nama_jenis FROM packages INNER JOIN jenis ON packages.Id_jenis = jenis.Id";
                      $result = $conn->query($sql);

                      if ($result->num_rows > 0) {
                        $no = 1; // Inisialisasi nomor baris
                        // Output data packages ke dalam tabel
                        while ($row = $result->fetch_assoc()) {
                          echo "<tr>";
                          echo "<td>" . $no . "</td>";
                          echo "<td>" . $row["Nama_Packages"] . "</td>";
                      ...
                      <?php
                        ...
                        echo "<tr><td colspan='6'>Tidak ada data packages.</td></tr>";
                      }
